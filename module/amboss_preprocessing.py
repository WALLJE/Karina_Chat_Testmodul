...
def ensure_amboss_summary(
    ...
    *,
    ...
    prompt = (
        ...
        "\n\n"
        "Erstelle vier sehr kurze Abschnitte mit fett formatierten Überschriften:"
        "\n1. Anamnese & Klinik"
        "\n2. Diagnostik"
        "\n3. Therapie"
        "\n4. Differentialdiagnosen"
        "\nNutze pro Abschnitt maximal drei ultrakurze Stichpunkte oder komprimierte Sätze, "
